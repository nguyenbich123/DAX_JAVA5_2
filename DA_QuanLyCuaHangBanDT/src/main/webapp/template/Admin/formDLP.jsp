		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Dung Lượng Pin</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
							...
							<form:form action="/admin/dlp/index" modelAttribute="item"
								...
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Mã dung lượng</label>
									<div class="col-sm-9">
										<form:input path="idDLP" type="text" class="form-control short-input"  readonly="true"  />
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
								...
								<div class="text-center">
									<button formaction="/admin/dlp/update" class="btn btn-primary">Lưu</button>
					...
					<div class="card">
						<div class="card-body">
							...
							<table class="table datatable">
								<thead>
									<tr>
										<th><a href="/admin/dlp/index?field=idDLP">Mã Công Nghệ</a></th>
										<th><a href="/admin/dlp/index?field=dlPin">Công Nghệ Pin</a></th>
									</tr>
								</thead>
								<tbody>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/dlp/delete/${item.idDLP}"><i
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${page.number > 0}">
								<li class="page-item"><a class="page-link"
									href="/admin/dlp/index?field=${field}&p=${page.number - 1}"
							...
							<c:forEach begin="1" end="${page.totalPages}" step="1"
								...
								<li
									...
									<a class="page-link"
									href="/admin/dlp/index?field=${field}&p=${number - 1}">${number}</a>
								</li>
							</c:forEach>
