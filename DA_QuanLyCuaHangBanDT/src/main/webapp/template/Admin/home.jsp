...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="FE_User.html">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Báo Cáo <span>/Today</span></h5>
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="/template/Admin/assets/img/product-1.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="/template/Admin/assets/img/product-2.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="/template/Admin/assets/img/product-3.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="/template/Admin/assets/img/product-4.jpg" alt=""></a></th>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="/template/Admin/assets/img/product-5.jpg" alt=""></a></th>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                    ...
                    <div class="activity-content">
                      <a href="#" class="fw-bold text-dark">Tuấn Du</a> đã trở lại trang
                    </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Chúc mừng <a href="#" class="fw-bold text-dark">Danh Thanh Huy</a> đã là quản trị viên  
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <i class='bi bi-circle-fill activity-badge text-success align-self-start'></i>
                  <div class="activity-content">
                    <a href="#" class="fw-bold text-dark">Danh Thanh Huy</a> đã trở lại trang
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                    ...
                    <div class="activity-content">
                      <a href="#" class="fw-bold text-dark">Danh Thanh Huy</a> đã rời khỏi trang
                    </div>
                  </div><!-- End activity item-->
