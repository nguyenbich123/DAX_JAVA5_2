...
<body>
		...
		<section class="section">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">DPG cam trước</h5>
							...
							<form:form action="/admin/dpgcs/index" modelAttribute="item"
										...
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
													...
													<form:input path="idDPGCT" type="text" class="form-control" />
								...
								<div class="row mb-3">
									<label for="inputPassword3" class="col-sm-3 col-form-label">DPG cam trước</label>
									<div class="col-sm-9">
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
								...
								<div class="text-center">
									<button formaction="/admin/dpgct/create"
										class="btn btn-primary">Create</button>
									<button formaction="/admin/dpgct/update"
					...
					<div class="card">
						<div class="card-body">
							...
							<table class="table datatable">
								<thead>
									<tr>
										<th><a href="/admin/dpgct/index?field=idDPGCT">Mã DPG </a></th>
										<th><a href="/admin/dpgct/index?field=dpg">DPG Cam Trước</a></th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="item" items="${page.content}">
										<tr>
											...
											<td>
												<div class="icon">
													<a href="/admin/dpgct/edit/${item.idDPGCT}"><i
														class="bi bi-pencil-fill"></i></a> <a
														href="/admin/dpgct/delete/${item.idDPGCT}"><i
  ...
  <ul class="pagination justify-content-center">
	...
	<c:if test="${page.number > 0}">
      <li class="page-item">
        <a class="page-link" href="/admin/dpgct/index?field=${field}&p=${page.number - 1}" aria-label="Previous">
    ...
    <c:forEach begin="1" end="${page.totalPages}" step="1" var="number">
      <li class="page-item <c:if test="${number == page.number +1}">active</c:if>">
        <a class="page-link" href="/admin/dpgct/index?field=${field}&p=${number - 1}">${number}</a>
      </li>
    </c:forEach>
    <c:if test="${page.number < page.totalPages}">
      <li class="page-item">
        <a class="page-link" href="/admin/dpgct/index?field=${field}&p=${page.number + 1}" aria-label="Next">
