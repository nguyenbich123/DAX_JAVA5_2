...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Độ Phân Giải Cam Trước</h1>
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="FE_home.html">Home</a></li>
					<li class="breadcrumb-item">Forms</li>
					<li class="breadcrumb-item active">Độ Phân Giải Cam Trước</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<!-- Horizontal Form -->
							<form:form action="/admin/dpgtc/index" modelAttribute="item"
								enctype="multipart/form-data">
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Mã DPG</label>
									<div class="col-sm-9">
										<form:input path="idDPGCT" type="text" class="form-control short-input"  readonly="true"  />
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
								...
								<div class="text-center">
									<button formaction="/admin/dpgct/update" class="btn btn-primary">Lưu</button>
							...
							<table class="table datatable">
								<thead>
									<tr>
										...
										<th><a href="/admin/dpgct/index?field=dpg">Độ Phân Giải</a></th>
									</tr>
								</thead>
								<tbody>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/dpgct/delete/${item.idDPGCT}"><i
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${page.number > 0}">
								<li class="page-item"><a class="page-link"
									href="/admin/dpgct/index?field=${field}&p=${page.number - 1}"
							...
							<c:forEach begin="1" end="${page.totalPages}" step="1"
								...
								<li
									...
									<a class="page-link"
									href="/admin/dpgct/index?field=${field}&p=${number - 1}">${number}</a>
								</li>
							</c:forEach>
