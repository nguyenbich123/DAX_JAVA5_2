...
<body>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Dung lượng sản phẩm</h5>
                            <!-- Horizontal Form -->
                            <form:form action="/admin/dungluong/index" modelAttribute="item"
										...
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
													...
													<form:input path="maDL" type="text" class="form-control" />
										...
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
													...
													<form:input path="dungLuong" type="text" class="form-control" />
                               ...
                               <div class="text-center">
									<button formaction="/admin/dungluong/create"
										class="btn btn-primary">Create</button>
									<button formaction="/admin/dungluong/update"
                    ...
                    <div class="card">
						<div class="card-body">
							...
							<table class="table datatable">
								<thead>
									<tr>
										<th><a href="/admin/dungluong/index?field=maDL">Mã Dung Lượng </a></th>
										<th><a href="/admin/dungluong/index?field=dungLuong">Dung Lượng </a></th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="item" items="${page.content}">
										<tr>
											...
											<td>
												<div class="icon">
													<a href="/admin/dungluong/edit/${item.maDL}"><i
														class="bi bi-pencil-fill"></i></a> <a
														href="/admin/dungluong/delete/${item.maDL}"><i
  ...
  <ul class="pagination justify-content-center">
    <c:if test="${page.number > 0}">
      <li class="page-item">
        <a class="page-link" href="/admin/dungluong/index?field=${field}&p=${page.number - 1}" aria-label="Previous">
    ...
    <c:forEach begin="1" end="${page.totalPages}" step="1" var="number">
      <li class="page-item <c:if test="${number == page.number +1}">active</c:if>">
        <a class="page-link" href="/admin/dungluong/index?field=${field}&p=${number - 1}">${number}</a>
      </li>
    </c:forEach>

    <c:if test="${page.number < page.totalPages}">
      <li class="page-item">
        <a class="page-link" href="/admin/dungluong/index?field=${field}&p=${page.number + 1}" aria-label="Next">
