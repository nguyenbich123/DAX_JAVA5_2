							...
							<form:form action="/admin/dungluong/index" modelAttribute="item"
								...
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Dung Lượng</label>
									<div class="col-sm-9">
										<form:input path="dungLuong" type="text" class="form-control short-input" />
										<form:errors path="dungLuong" cssClass="text-danger" />
									</div>
								</div>
		...
		<section class="section">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">Dung lượng điện thoại</h5>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/dungluong/delete/${item.maDL}"><i
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${page.number > 0}">
								<li class="page-item"><a class="page-link"
									href="/admin/dungluong/index?field=${field}&p=${page.number - 1}"
							...
							<c:forEach begin="1" end="${page.totalPages}" step="1"
								...
								<li
									...
									<a class="page-link"
									href="/admin/dungluong/index?field=${field}&p=${number - 1}">${number}</a>
								</li>
							</c:forEach>
