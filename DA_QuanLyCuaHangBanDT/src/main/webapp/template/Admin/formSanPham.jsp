                            ...
                            <form action="save" method="post" enctype="multipart/form-data">
                              <div class="row mb-3" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                      <input type="text" class="form-control" id="inputEmail" placeholder="VD: Apple A17 Pro 6 nhân">
                                  </div>
                                </div>
                                  <hr>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="inputEmail" placeholder="VD: 1 Nano SIM & 1 eSIM">
                                    </div>
                                </div>
                                  <hr>
                                <div class="row mb-3">
