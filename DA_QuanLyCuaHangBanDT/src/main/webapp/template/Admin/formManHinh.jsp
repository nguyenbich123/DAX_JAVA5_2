        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Thêm Màn Hình</h5>

                            <!-- Horizontal Form -->
                            <form action="save" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    <label for="inputName" class="col-sm-3 col-form-label">Công Nghệ Màn Hình</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Độ Phân Giải</label>
                                    <div class="col-sm-9 ">
                                        <div class="">
                                            <input type="text" class="form-control">
                                        </div>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Super Retina XDR (1290 x 2796 Pixels)</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>OLED</td>
