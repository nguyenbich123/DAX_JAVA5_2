...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <form:form action="/admin/mau/index" modelAttribute="item"
										...
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
													...
													<form:input path="maMau" type="text" class="form-control" />
                               ...
                               <div class="text-center">
									<button formaction="/admin/mau/create"
										class="btn btn-primary">Create</button>
									<button formaction="/admin/mau/update"
											...
											<td>
												<div class="icon">
													<a href="/admin/mau/edit/${item.maMau}"><i
														...
														href="/admin/mau/delete/${item.maMau}"><i
  ...
  <ul class="pagination justify-content-center">
    <c:if test="${page.number > 0}">
      <li class="page-item">
        <a class="page-link" href="/admin/mau/index?field=${field}&p=${page.number - 1}" aria-label="Previous">
    ...
    <c:forEach begin="1" end="${page.totalPages}" step="1" var="number">
      <li class="page-item <c:if test="${number == page.number +1}">active</c:if>">
        <a class="page-link" href="/admin/mau/index?field=${field}&p=${number - 1}">${number}</a>
      </li>
    </c:forEach>

    <c:if test="${page.number < page.totalPages}">
      <li class="page-item">
        <a class="page-link" href="/admin/mau/index?field=${field}&p=${page.number + 1}" aria-label="Next">
