		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Loại Pin</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
							...
							<form:form action="/admin/lp/index" modelAttribute="item"
								...
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Mã Loại</label>
									<div class="col-sm-9">
										<form:input path="idlp" type="text" class="form-control short-input"  readonly="true"  />
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Loại pin</label>
									<div class="col-sm-9">
										<form:input path="loaiPin" type="text" class="form-control short-input" />
									</div>
								</div>
								<div class="text-center">
									<button formaction="/admin/lp/update" class="btn btn-primary">Lưu</button>
					...
					<div class="card">
						<div class="card-body">
							...
							<table class="table datatable">
								<thead>
									<tr>
										<th><a href="/admin/lp/index?field=idlp">Mã Loại</a></th>
										<th><a href="/admin/lp/index?field=loaiPin">Loại Pin</a></th>
									</tr>
								</thead>
								<tbody>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/lp/delete/${item.idlp}"><i
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${page.number > 0}">
								<li class="page-item"><a class="page-link"
									href="/admin/lp/index?field=${field}&p=${page.number - 1}"
							...
							<c:forEach begin="1" end="${page.totalPages}" step="1"
								...
								<li
									...
									<a class="page-link"
									href="/admin/lp/index?field=${field}&p=${number - 1}">${number}</a>
								</li>
							</c:forEach>
