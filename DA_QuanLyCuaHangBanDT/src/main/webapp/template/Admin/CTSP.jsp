              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>5</td>
                    <td>29.900.000 đ</td>
                    <td><img src="/template/Admin/assets/img/profile-img.jpg" alt="" width="15%" height="15%"></td>
                    <td>
                      <div class="icon">
                  ...
                  <tr>
                    ...
                    <td>5</td>
                    <td>29.900.000 đ</td>
                    <td><img src="/template/Admin/assets/img/profile-img.jpg" alt="" width="15%" height="15%"><img src="/template/Admin/assets/img/profile-img.jpg" alt="" width="15%" height="15%"></td>
                    <td>
                      <div class="icon">
                        <a><i class="bi bi-pencil-fill"></i></a>
                        <a><i class="ri-delete-bin-5-fill"></i></a>
