...
<body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="FE_home.html">
        ...
        <li class="nav-item">
          ...
          <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="FE_formSP.html">
                <i class="bi bi-circle"></i><span>Form  Sản Phẩm</span>
              </a>
            </li>
            <li>
              <a href="FE_formCTSP.html">
                <i class="bi bi-circle"></i><span>Form Chi Tiết Sản Phẩm</span>
              </a>
            </li>
          </ul>
        </li><!-- End Forms Nav -->
        ...
        <li class="nav-item">
          ...
          <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="FE_Account.html">
                <i class="bi bi-circle"></i><span>Quản Lý ACCOUNT</span>
              </a>
            </li>
            <li>
              <a href="FE_CTSP.html">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-address">Address</button>
                  </li>
              </ul>
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Lương Nguyễn Mến</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Số Điện Thoại</div>
                    <div class="col-lg-9 col-md-8">090 3094 405</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">0men0ngu0@gmail.com</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Địa Chỉ</div>
                    <div class="col-lg-9 col-md-8"> Cần Thơ</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="/template/Admin/assets/img/profile-img.jpg" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Nguyễn Mến">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px"> ghi gì thì ghi nhá ghi gì cho nó dài một síu không dài thì đừng ghi chứ ghi là phải ghi cho nó dài </textarea>
                      </div>
                    </div>
