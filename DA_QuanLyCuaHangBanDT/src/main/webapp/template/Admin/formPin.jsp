        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Thêm Pin</h5>
                            ...
                            <form action="save" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <div class="row">
                                                <div id="inputState" class="d-flex align-items-center">
                                                    <div class="form-check me-3">
                                                        <input class="form-check-input" type="radio" name="hotrosac"
                                                            id="hotrosac1" value="option1" checked>
                                                        <label class="form-check-label" for="hotrosac1">
                                                            20 W
                                                        </label>
                                                    </div>
                                                    <div class="form-check me-3">
                                                        <input class="form-check-input" type="radio" name="hotrosac"
                                                            id="hotrosac2" value="option2">
                                                        <label class="form-check-label" for="hotrosac2">
                                                            15 W
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-check me-3">
                                                        <input class="form-check-input" type="radio" name="hotrosac"
                                                            id="hotrosac3" value="option3">
                                                        <label class="form-check-label" for="hotrosac3">
                                                            10 W
                                                        </label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword3" class="col-sm-3 col-form-label">Công Nghệ
                                            Pin</label>
                                        <div class="col-sm-9 ">
                                            <div class="">
                                                <input type="text" class="form-control">
