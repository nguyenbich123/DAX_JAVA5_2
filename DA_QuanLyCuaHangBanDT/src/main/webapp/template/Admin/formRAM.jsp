...
<body>
		...
		<section class="section">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">Ram sản phẩm</h5>
							...
							<form:form action="/admin/ram/index" modelAttribute="item"
										...
										<div class="row">
											<div class="col-md-4">
												<div id="inputState" class="d-flex align-items-center">
													...
													<form:input path="maRam" type="text" class="form-control" />
								...
								<div class="text-center">
									<button formaction="/admin/ram/create"
										class="btn btn-primary">Create</button>
									<button formaction="/admin/ram/update"
					...
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">Dung Lượng RAM</h5>
							<!-- Table with stripped rows -->
							<table class="table datatable">
								<thead>
									<tr>
										<th><a href="/admin/ram/index?field=maRam">Mã Dung Lượng RAM </a></th>
										<th><a href="/admin/ram/index?field=ram">Dung Lượng RAM</a></th>
									</tr>
								</thead>
								<tbody>
											...
											<td>
												<div class="icon">
													<a href="/admin/ram/edit/${item.maRam}"><i
														...
														href="/admin/ram/delete/${item.maRam}"><i
  ...
  <ul class="pagination justify-content-center">
	...
	<c:if test="${page.number > 0}">
      <li class="page-item">
        <a class="page-link" href="/admin/ram/index?field=${field}&p=${page.number - 1}" aria-label="Previous">
    ...
    <c:forEach begin="1" end="${page.totalPages}" step="1" var="number">
      <li class="page-item <c:if test="${number == page.number +1}">active</c:if>">
        <a class="page-link" href="/admin/ram/index?field=${field}&p=${number - 1}">${number}</a>
      </li>
    </c:forEach>
    <c:if test="${page.number < page.totalPages}">
      <li class="page-item">
        <a class="page-link" href="/admin/ram/index?field=${field}&p=${page.number + 1}" aria-label="Next">
