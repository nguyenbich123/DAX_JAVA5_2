        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Thêm Mã Giả Giá</h5>

                            <!-- Horizontal Form -->
                            <form action="save" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    <label for="inputName" class="col-sm-3 col-form-label">Mã Giảm Giá</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="input" class="col-sm-3 col-form-label">Đơn Hàng Tối Thiểu</label>
                                    <div class="col-sm-9 ">
                                            <input type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="input" class="col-sm-3 col-form-label">Số Tiền Giảm Tối Đa</label>
                                    <div class="col-sm-9 ">
                                        <input type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="input" class="col-sm-3 col-form-label">Thời Gian Áp Dụng</label>
                                    <div class="col-sm-9 ">                                       
                                            <input type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="input" class="col-sm-3 col-form-label">Thời Gian Kết Thúc</label>
                                    <div class="col-sm-9 ">                                       
                                            <input type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="input" class="col-sm-3 col-form-label">Ảnh </label>
                                    <div class="col-sm-9 ">                                       
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Quản Lý Pin</h5>

                            <!-- Table with stripped rows1 -->
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>22/04/2024</td>
                                        <td>22/07/2024</td>
                                        <td><img src="/template/Admin/assets/img/samsung-galaxy-s23-ultra-5-1.jpg" alt="" style="max-width: 100px;"></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>GG499k70k3th</td>
                                        ...
                                        <td>22/04/2024</td>
                                        <td>22/07/2024</td>
                                        <td><img src="/template/Admin/assets/img/iphone-13-xanh-glr-5.jpg" alt="" style="max-width: 100px;"></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>GG499k70k3th</td>
