...
<head>
    ...
    <link href="/template/Admin/assets/css/btnRadio.css" rel="stylesheet">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="save" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    <label for="inputName" class="col-sm-3 col-form-label">Độ Phân Giải</label>
                                    <div class="col-sm-9">
                                        <div class="row">
                                ...
                                <div class="row mb-3">
                                    <label for="inputName" class="col-sm-3 col-form-label">Đèn Flash</label>
                                    <div class="col-sm-9">

                                        <input type="radio" id="radio1" name="radioGroup" value="Có">
                                        <label for="radio1"> Có </label>


                                        <input type="radio" id="radio2" name="radioGroup" value="Không">
                                        <label for="radio2"> Không </label>
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Tính Năng</label>
                                    <div class="col-sm-9 ">
                                        <div class="">
