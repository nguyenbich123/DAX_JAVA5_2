		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Tính Năng Cam Trước</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
							...
							<form:form action="/admin/tnct/index" modelAttribute="item"
								...
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
										Mã Tính Năng</label>
									<div class="col-sm-9">
										<form:input path="idTNCT" type="text" class="form-control short-input"  readonly="true"  />
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputName" class="col-sm-3 col-form-label">
								...
								<div class="text-center">
									<button formaction="/admin/tnct/update" class="btn btn-primary">Lưu</button>
							...
							<table class="table datatable">
								<thead>
									<tr>
										...
										<th><a href="/admin/tnct/index?field=tinhNang">Tính năng</a></th>
									</tr>
								</thead>
								<tbody>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/tnct/delete/${item.idTNCT}"><i
						...
						<ul class="pagination justify-content-center">
							...
							<c:if test="${page.number > 0}">
								<li class="page-item"><a class="page-link"
									href="/admin/tnct/index?field=${field}&p=${page.number - 1}"
							...
							<c:forEach begin="1" end="${page.totalPages}" step="1"
								...
								<li
									...
									<a class="page-link"
									href="/admin/tnct/index?field=${field}&p=${number - 1}">${number}</a>
								</li>
							</c:forEach>
