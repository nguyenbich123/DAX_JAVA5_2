...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Độ Phân Giải Cam Sau</h1>
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="FE_home.html">Home</a></li>
					<li class="breadcrumb-item">Forms</li>
					<li class="breadcrumb-item active">Độ Phân Giải Cam Sau</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
						...
						<div class="card-body">
							...
							<form:form action="/admin/dpgcs/index" modelAttribute="item"
								...
								<div class="text-center">
									<button formaction="/admin/dpgcs/update" class="btn btn-primary">Lưu</button>
							...
							<table class="table datatable">
								<thead>
									<tr>
										...
										<th><a href="/admin/dpgcs/index?field=dpg">Độ Phân Giải</a></th>
									</tr>
								</thead>
								<tbody>
										...
										<tr>
											...
											<td>
												<div class="icon">
													...
													<a href="/admin/dpgcs/delete/${item.idDPGCS}"><i
