...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="banner">
      <img src="/template/user/images/color_banner.jpg" alt="">
      <div class="color_banner">
        <img src="/template/user/images/TheLiem.png" alt="" />
      <div class="title">
        <div class="content">
          <h1>Chào mừng bạn đến với trang web của chúng tôi</h1>
          <p style="color: rgb(105, 104, 104);">
            Vui lòng đăng nhập hoặc đăng ký để trải nghiệm đầy đủ các tính năng
            của trang web.
          </p>
        </div>
        <form action="">
        	<div class="button-register">
            <a href="/account/login" class="btn btn-danger p-3 m-1">Đăng nhập</a>
            <a href="/account/signup" class="btn btn-dark p-3">Đăng ký</a>
          </div>
        </form>
      </div>
      </div>
