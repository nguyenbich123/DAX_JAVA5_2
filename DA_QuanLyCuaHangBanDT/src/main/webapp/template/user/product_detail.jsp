						...
						<div class="offcanvas-body">
							<ul id="navbar"
								...
								<li class="nav-item"><a class="nav-link me-4 active"
									href="#billboard">Trang chủ</a></li>
								<li class="nav-item"><a class="nav-link me-4"
									href="#company-services">Dịch vụ</a></li>
								<li class="nav-item"><a class="nav-link me-4"
									href="#mobile-products">Sản phẩm</a></li>
								<li class="nav-item"><a class="nav-link me-4"
									href="#yearly-sale">Khuyến mãi</a></li>
								<li class="nav-item dropdown"><a
									class="nav-link me-4 dropdown-toggle link-dark"
									data-bs-toggle="dropdown" href="#" role="button"
									aria-expanded="false">Trang</a>
									<ul class="dropdown-menu">
										...
										<li>
										<li><a href="" class="dropdown-item">Liên hệ</a></li>
										<li><a href="" class="dropdown-item">Giới Thiệu</a></li>
										<li><a href="" class="dropdown-item">Góp Ý</a></li>
									</ul></li>
								<li class="nav-item">
									<div class="user-items ps-5">
										<ul class="d-flex justify-content-end list-unstyled">
                              ...
                              <use xlink:href="#user"></use>
												...
												<ul class="dropdown-menu ">
													<li><a href="" class="dropdown-item">Chỉnh sửa
															thông tin</a></li>
													<li><a href="" class="dropdown-item">Đơn hàng của
															tôi</a></li>
													<li><a href="/account/logout" class="dropdown-item">Đăng
															xuất</a></li>
													<li><a href="/account/resetpass" class="dropdown-item">Đổi
															mật khẩu</a></li>
													<li>
												</ul></li>
											<li><a
				...
				<div class="col-lg-7 mt-5">
					<div class="card">
						<div class="card-body">
									...
									<div class="col-auto">
										<ul class="list-inline pb-3">
											...
											<li class="list-inline-item"><a href=""
												class="btn btn-warning" id="btn-minus">-</a></li>
							...
							<%-- <form action="/product/add-to-cart/${sanPham.maCTSP}"
								method="post">
								<input type="hidden" name="product-title" value="Activewear">
								<div class="row">
									<div class="col-auto">
										<ul class="list-inline pb-3">
											<li class="list-inline-item text-right">Quantity <input
												type="hidden" name="product-quantity" id="product-quantity"
												value="1"> <!-- Thêm các nút để tăng giảm số lượng -->
												<a href="#" class="btn btn-warning" id="btn-minus">-</a> <span
												class="badge bg-secondary" id="var-value">1</span> <a
												href="#" class="btn btn-warning" id="btn-plus">+</a>
											</li>
										</ul>
									</div>
								</div>
								<div class="row pb-3">
									...
									<div class="col d-grid">
										<button type="submit" class="btn btn-warning btn-lg">Add
											To Cart</button>
									</div>
								</div>
							</form> --%>
			...
			<ul class="pagination pagination-lg justify-content-end">
				<c:forEach begin="1" end="${page.totalPages}" step="1" var="number">
					<li class="page-item ${page.number == number - 1 ? 'active' : ''}">
						...
						href="/product/product-detail/${sanPham.maCTSP}?p=${number-1}"
						tabindex="-1">${number}</a>
					</li>
				</c:forEach>
			</ul>
