      ...
      <div class="row">
          ...
          <div class="col-lg-2">
              ...
              <ul class="list-unstyled templatemo-accordion">
                  <li class="pb-3">
                      <a class="collapsed d-flex justify-content-between  text-decoration-none" href="#iphone">
                          Iphone
                      </a>
                  </li>
                  <li class="pb-3">
              ...
              <div class="filter-price py-1">
                <div class="from-price  d-flex">
                  <input type="text" maxlength="14" placeholder="Từ" class="form-control">
                  <div class="filter-price-line">
                  </div>
                  <input type="text" maxlength="14" placeholder="Đến" class="form-control">
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-10">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3">
                      <div class="card mb-4 product-wap rounded-0">
                          <div class="card rounded-0">
                              <img class="card-img rounded-0 img-fluid" src="/template/user/images/dt14.jpg"/>
                              <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled d-flex">
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-heart"></i></a></li>
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-eye"></i></a></li>
                    ...
                    <div class="col-md-3">
                      <div class="card mb-4 product-wap rounded-0">
                          <div class="card rounded-0">
                              <img class="card-img rounded-0 img-fluid" src="/template/user/images/dt18.jpg"/>
                              <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled d-flex">
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-heart"></i></a></li>
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-eye"></i></a></li>
                    ...
                    <div class="col-md-3">
                      <div class="card mb-4 product-wap rounded-0">
                          <div class="card rounded-0">
                              <img class="card-img rounded-0 img-fluid" src="/template/user/images/dt19.jpg"/>
                              <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled d-flex">
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-heart"></i></a></li>
                                  <li><a class="btn btn-success text-white m-1" href="details_product.html"><i class="far fa-eye"></i></a></li>
