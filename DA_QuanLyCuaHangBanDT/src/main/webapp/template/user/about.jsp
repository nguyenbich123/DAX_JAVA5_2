...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
    ...
    <div style="margin-top: 50px;">
        <section class="container py-5">
            ...
            <section class="hero-section py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="https://picsum.photos/1200/800" alt="..." class="img-fluid">
                        </div>
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="hero-content">
                                <h2>Điện thoại chính hãng - Giá tốt</h2>
                                <p>Cung cấp đa dạng các dòng điện thoại chính hãng từ các thương hiệu uy tín. Giá cả
                                    cạnh tranh,
                                    dịch vụ bảo hành chu đáo.</p>
                                <a href="#" class="btn btn-lg btn-dark">Mua ngay</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="container py-5">
            <hr>
            <h2 style="text-align: center; margin: 50px;">Tại sao chọn chúng tôi?</h2>
            <hr>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <p>Cam kết mang đến cho khách hàng sản phẩm chất lượng với giá cả cạnh tranh nhất thị trường.</p>
                </div>
                <div class="col-md-4">
                    <i class="fa fa-gift fa-5x"></i>
                    <h3>Khuyến mãi hấp dẫn</h3>
                    <p>Cung cấp nhiều chương trình khuyến mãi hấp dẫn cho khách hàng throughout the year.</p>
                </div>
            </div>
            <hr>
        </section>
