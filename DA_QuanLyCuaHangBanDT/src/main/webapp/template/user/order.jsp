...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/template/user/css/donhang.css">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                  <tr>
                    <td>5FHLA4UL</td>
                    <td><img src="/template/user/images/dt1.jpg" alt="" width="80" /></td>
                    ...
                    <td>
                      <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Chi tiết</a>
                    </td>
                    <!-- Modal -->
                    <div
                      class="modal fade"
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Mã đơn: 5FHLA4UL</p>
                            <p>
                              Sản phẩm: <img src="/template/user/images/iphone-15-pro-max_256GB.webp" alt="" width="50" /> </p>
                            <p>Tên sản phẩm: Iphone-15-Pro-Max</p>
                            <p>Màu: <span class="color-circle" style="background-color: black;"></span></p> 
                            ...
                            <hr>
                            <p style="color: rgb(129, 129, 22);">Ngày giao hàng dự kiến: 26/05/2024</p>
                            <p style="color: green;">Tùy chọn thanh toán: Thanh toán online</p>
                            <p style="color: yellow;">Trạng thái: Đang giao</p>
                            <!-- Thêm các trường thông tin khác tùy thuộc vào nhu cầu của bạn -->
                          </div>
                          <div class="modal-footer">
                            <button
                              type="button" class="btn btn-secondary" data-bs-dismiss="modal"> Đóng </button>
                  ...
                  <tr>
                    <td>5F6NYF71</td>
                    <td><img src="/template/user/images/dt16.jpg" alt="" width="80" /></td>
                    <td>SamSung Galaxy S23 Utra</td>
                    <td>23.500.000 VND</td>
                    <td>22/03/2024</td>
                    <td>Thanh toán COD</td>
                    <td style="color: green">Đã giao</td>
                    <td>
                      <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">Chi tiết</a>
                      <div
                      class="modal fade"
                      id="exampleModal1"
                      tabindex="-1"
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Mã đơn: 5FHLA4UL</p>
                            <p>
                              Sản phẩm: <img src="/template/user/images/dt16.jpg" alt="" width="50" /> </p>
                            <p>Tên sản phẩm: SamSung Galaxy S23 Utra</p>
                            <p>Tổng phí dịch vụ: 23.500.000 VND</p>
                            <hr>
                            <p>Tên Khách hàng: Danh Thanh Huy</p>
                            <p>Số điện thoại: 036* *** ***</p>
                            <p>Địa chỉ: Phú Quốc-Kiêng Giang </p>
                            <hr>
                            <p style="color: green;">Ngày Giao: 28/03/2024</p>
                            <p style="color: green;">Tùy chọn thanh toán: Thanh toán COD</p>
                            <p style="color: green;">Trạng thái: Đã giao</p>
                            <!-- Thêm các trường thông tin khác tùy thuộc vào nhu cầu của bạn -->
                          </div>
                          <div class="modal-footer">
                            <button
                  ...
                  <tr>
                    <td>5FFY342A</td>
                    <td>
                      <img src="/template/user/images/3tr2OppoA18.jpg" alt="" width="80" />
                    </td>
                    <td>Oppo A18</td>
                    <td>3.200.000 VND</td>
                    <td>12/05/2024</td>
                  ...
                  <tr>
                    <td>5F45486A</td>
                    <td><img src="/template/user/images/dt12.jpg" alt="" width="80" /></td>
                  ...
                  <tr>
                    <td>5F45486B</td>
                    <td><img src="/template/user/images/dt4.jpg" alt="" width="80" /></td>
                    <td>iphone-15-pro-max</td>
                    <td>27.500.000VND</td>
                    <td>22/05/2024</td>
                    <td>Thanh toán online</td>
