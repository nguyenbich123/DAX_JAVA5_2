...
<head>
    <title>TheLiem-Cua hang dien thoai</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/template/user/css/lienHe.css">
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
                            ...
                            <ul id="navbar"
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link me-4 dropdown-toggle link-dark" data-bs-toggle="dropdown"
                                        href="#" role="button" aria-expanded="false">Trang</a>
    ...
    <div class="container mt-4">
        <div class="bg-primary text-white p-4"
            style="height: 80px; text-align: center; background: linear-gradient(to left, #4daf54, #88513d); margin-top: 90px; margin-bottom: 30px; border-radius: 10px;">
            <h1 style="padding-bottom:20px;">THÔNG TIN LIÊN LẠC</h1>
        </div>
        <div style="text-align: center;">
            <strong>
                <h2>Địa chỉ cửa hàng The Liem</h2>
            </strong>
            <address>
        ...
        <div class="row">
            <div class="col-md-6 mt-3">
                <h1 class="fa-solid fa-phone" style="float: left !important; margin-top: 20px !important;"></h1>
                <div style="float: left !important; margin-left: 15px ;">
                    <p>
                    <h3>Điện thoại:</h3>
                    0988517777</p>
                    <p>Giờ làm việc: <br>
                        8h30-18h00 từ thứ hai đến thứ sáu và các ngày thứ bảy của tuần lẻ.</p>
                </div>
            </div>
            <div class="col-md-6 mt-3" style="">
                <h1 class="fa-solid fa-mobile" style="float: left !important; margin-top: 20px !important;"></h1>
                <div style="float: left !important; margin-left: 15px !important;">
                    <p>
                    <h3>Tổng đài hỗ trợ:</h3>
                    1900 6933</p>
                    <p>Giờ làm việc: <br>
                        8h-12h00 và 13h00-23h00 tất cả các ngày trong tuần.</p>
                </div>
            </div>
        </div>
        <hr>
        <div style="text-align: center !important; margin: 0 auto !important;">
            ...
            <a href="#" style="font-size: medium;">Hỗ trợ sử dụng: hotro@theliem.vn</a>
            <br>
            <a href="#" style="font-size: medium;">Tư vấn sản phẩm: cskh@theliem.vn</a>
            <br>
            <a href="#" style="font-size: medium;">Hỗ trợ đặt hàng: dathang@theliem.vn</a>
        </div>
        <hr>
    </div>

    <footer id="footer" class="overflow-hidden mt-3">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row d-flex flex-wrap justify-content-between">
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu">
                                <img src="/template/user/images/2.png" alt="logo">
