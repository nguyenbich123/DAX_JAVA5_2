...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="search-popup">
      <div class="search-popup-container">
        ...
        <form role="search" method="get" class="search-form" action="">
          <input type="search" id="search-form" class="search-field" placeholder="Tìm kiếm" value="" name="s" />
        ...
        <ul class="cat-list">
          <li class="cat-list-item">
            <a href="#" title="Mobile Phones">Iphone15</a>
          </li>
          <li class="cat-list-item">
            <a href="#" title="Smart Watches">Samsung S23 Ultra</a>
          </li>
          <li class="cat-list-item">
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                  <div class="image-holder">
                    <img  src="/template/user/images/banner_iphone15.png" alt="banner">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                ...
                <p>Chúng tôi cung cấp dịch vụ giao hàng miễn phí cho tất cả các đơn hàng.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                ...
                <p>Sản phẩm của chúng tôi luôn được đảm bảo chất lượng cao.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                ...
                <p>Chúng tôi có các ưu đãi và khuyến mãi hàng ngày dành cho khách hàng.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">Thanh toán 100% an toàn</h3>
                <p>Chúng tôi đảm bảo các giao dịch thanh toán luôn an toàn và bảo mật.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/oppo_reno11F5G_8GB.webp" alt="product-item" class="img-fluid">
                  </div>
                  ...
                  <div class="card-detail  justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#">OPPO Reno11 F 5G 8GB 256GB</a>
                    </h3>
                    <span class="item-price text-primary">8.190.000đ</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/iphone-15-pro-max_256GB.webp" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                  ...
                  <div class="card-detail  justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#">Iphone 15Promax 256GB</a>
                    </h3>
                    <span class="item-price text-primary">29.290.000đ</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/s23_ultra_black.webp" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                  ...
                  <div class="card-detail  justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#">Galaxy S23 Ultra 256GB</a>
                    </h3>
                    <span class="item-price text-primary">20.300.000đ</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/redme_not12.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                  ...
                  <div class="card-detail  justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#">Xiaomi Redmi Note 12 8GB</a>
                    </h3>
                    <span class="item-price text-primary">5.790.000đ</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
          ...
          <div class="swiper product-watch-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/product-item6.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/product-item7.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/product-item8.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/product-item9.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="/template/user/images/product-item10.jpg" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
    ...
    <section id="yearly-sale" class="bg-light-blue overflow-hidden mt-5 padding-xlarge" style="background-image: url('/template/user/images/single-image1.png');background-position: right; background-repeat: no-repeat;">
      <div class="row d-flex flex-wrap align-items-center">
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="/template/user/images/post-item1.jpg" alt="" class="img-fluid">
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="/template/user/images/post-item2.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="/template/user/images/post-item3.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
    ...
    <section id="testimonials" class="position-relative" style="font-family: Arial, Helvetica, sans-serif;">
      <div class="container">
        <div class="row">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide text-center d-flex justify-content-center">
                  <div class="review-item col-md-10">
                    ...
                    <blockquote>“Thời gian có thể linh hoạt, giá trị quan trọng, luôn luôn duy trì sự hoàn thiện.”</blockquote>
                    <div class="rating">
                ...
                <div class="swiper-slide text-center d-flex justify-content-center">
                  <div class="review-item col-md-10">
                    <i class="icon icon-review"></i>
                    <blockquote>“Blog là một ấn phẩm kỹ thuật số có thể bổ sung cho một trang web hoặc tồn tại độc lập. Blog có thể bao gồm các bài viết, bài đăng ngắn, danh sách, đồ họa thông tin, video và nội dung kỹ thuật số khác.”</blockquote>
                    <div class="rating">
                      <svg class="star star-fill">
                        <use xlink:href="#star-fill"></use>
                      </svg>
            ...
            <div class="col-md-5 col-sm-12">
              <form class="subscription-form validate">
                <div class="input-group flex-wrap">
                  <input class="form-control btn-rounded-none" type="email" name="EMAIL" placeholder="Nhập địa chỉ email của bạn" required="">
                  <button class="btn btn-medium btn-primary text-uppercase btn-rounded-none" type="submit" name="subscribe">Đăng Ký</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="d-flex flex-wrap">
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="/template/user/images/insta-item1.jpg" alt="instagram" class="insta-image">
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="/template/user/images/insta-item2.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="/template/user/images/insta-item3.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="/template/user/images/insta-item4.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="/template/user/images/insta-item5.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <div class="row d-flex flex-wrap justify-content-between">
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu">
                  ...
                  <div class="footer-section">
                    <p>Chỉ bán sản phẩm chính hãng, đảm bảo chất lượng cao nhất.</p>
              ...
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu contact-item">
                  ...
                  <p>Bạn có bất kỳ thắc mắc hoặc đề xuất nào? <a href="mailto:">theliem2024@gmail.com</a>
                  </p>
                  <p>Nếu bạn cần hỗ trợ? Hãy gọi cho chúng tôi. <a href="">+84 111 222 333</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <div id="footer-bottom">
      <div class="container">
        <div class="row d-flex flex-wrap justify-content-between">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="copyright">
              <p>© Copyright 2024 TheLiem. Design by TheLiem Team. All rights reserved.</p>
              </p>
            </div>
          </div>
        </div>
    ...
    <script type="text/javascript" src="/template/user/js/bootstrap.bundle.min.js"></script>
