...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/template/user/css/common.css">
    <link rel="stylesheet" href="/template/user/css/cart.css">
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="m-4 py-3">
        ...
        <div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="quantity-container d-flex">
                                        ...
                                        <input type="number" class="form-control mx-1"  min="1" value="1" readonly>
            ...
            <div class="d-flex justify-content-end py-2"> <!-- Thêm dòng này để căn chỉnh nút mua hàng về bên phải -->
    ...
    <script type="/template/user/text/javascript" src="js/bootstrap.bundle.min.js"></script>
