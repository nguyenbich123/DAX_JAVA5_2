...
<body data-bs-spy="scroll" data-bs-target="#navbar"
	...
	<!-- Đoạn mã HTML để hiển thị thông báo lỗi -->
							...
							<ul id="navbar"
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu">
										...
										<li>
										<li><a href="lienHe.html" class="dropdown-item">Liên
												hệ</a></li>
										<li><a href="gioiThieu.html" class="dropdown-item">Giới
												Thiệu</a></li>
										<li><a href="gopY.html" class="dropdown-item">Góp Ý</a></li>
									</ul></li>
								<li class="nav-item">
									<div class="user-items ps-5">
										<ul class="d-flex justify-content-end list-unstyled">
