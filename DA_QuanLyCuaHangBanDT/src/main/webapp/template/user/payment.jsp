...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <script src="https://kit.fontawesome.com/49bc4d7d5f.js" crossorigin="anonymous"></script>
    <!-- <link rel="stylesheet" href="css/layout.css"> -->
    <!-- script
    ================================================== -->
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-8">
                <h2 style="font-weight: bold;">Thanh toán hóa đơn</h2>
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="number" class="form-control" id="amount" placeholder="0" disabled>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label for="note">Địa Chỉ</label>
                                <input class="form-control" id="adress"></input>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <a href="#" style="margin-right: 5px;">
                                    <button class="btn btn-warning" id="btnOnlinePayment">Thanh Toán Online</button>
                                </a>

                                <a href="#">
                                    <button class="btn btn-secondary" id="btnCashOnDelivery">Thanh Toán Khi Nhận
                                        Hàng</button>
                                </a>
                            </div>

                            <div class="col-md-12 payment-options" style="display: none; margin-top: 10px;">
                                <input type="radio" id="radio1" name="radioGroup" value="option1" class="radio-custom">
                                <label for="radio1">
                                    <i class="fa-solid fa-credit-card" style="margin-right: 5px;"></i> ATM
                                </label>
                                <br>
                                <input type="radio" id="radio2" name="radioGroup" value="option2" class="radio-custom">
                                <label for="radio2">
                                    <i class="fa-brands fa-cc-paypal" style="margin-right: 5px;"></i> Paypal
                                </label>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label for="note">Nhập Mã Giảm Giá (Nếu Có):</label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Cam kết mang đến cho khách hàng sản phẩm chất lượng với giá cả cạnh tranh nhất
                                    thị
                                    trường.</p>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Cung cấp nhiều chương trình khuyến mãi hấp dẫn cho khách hàng throughout the
                                    year.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row d-flex flex-wrap justify-content-between">
                                ...
                                <div class="col-lg-3 col-sm-6 pb-3">
                                    <div class="footer-menu contact-item">
                                        ...
                                        <p>Bạn có bất kỳ thắc mắc hoặc đề xuất nào? <a
                                                href="mailto:">theliem2024@gmail.com</a>
                                        </p>
